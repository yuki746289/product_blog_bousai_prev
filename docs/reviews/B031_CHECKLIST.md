...
- reader_problem: `非常食の賞味期限が切れたらどうする？入れ替え・消費・ローリングストック` に対応する判断・準備事項を整理したい
...
- research: `docs/research/B031_SOURCES.md`（存在する場合）
- preview: `preview/article_b031.html`
- production: `guide/emergency-food-expiration.html`
