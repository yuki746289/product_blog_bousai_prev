...
- reader_problem: `防災ラジオは必要？情報収集手段を比較する` に対応する判断・準備事項を整理したい
...
- source: `content/articles/B027_emergency_radio_guide.md`
- research: `docs/research/B027_SOURCES.md`（存在する場合）
- preview: `preview/article_b027.html`
- production: `goods/emergency-radio-guide.html`
