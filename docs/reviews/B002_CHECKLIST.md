...
- reader_problem: `防災リュックの中身は何を入れる？最低限の持ち出し品と重さ・置き場所` に対応する判断・準備事項を整理したい
...
- source: `content/articles/B002_emergency_bag_basics.md`
- research: `docs/research/B002_SOURCES.md`（存在する場合）
- preview: `preview/article_b002.html`
- production: `guide/emergency-bag-basics.html`
