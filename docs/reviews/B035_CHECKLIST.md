...
- reader_problem: `高齢者の防災は何を準備する？薬・補聴器・入れ歯・避難支援を確認` に対応する判断・準備事項を整理したい
...
| C02 出典・安全性 | PASS | 確認済み一次・公的/メーカー情報を優先。source_checked_at=2026-09-03 |
...
- source: `content/articles/B035_senior_disaster_preparedness.md`
- research: `docs/research/B035_SOURCES.md`（存在する場合）
- preview: `preview/article_b035.html`
- production: `guide/senior-disaster-preparedness.html`
