...
- reader_problem: `断水時の携帯トイレ｜使い方・処分・衛生と必要数の考え方` に対応する判断・準備事項を整理したい
...
- source: `content/articles/B003_portable_toilet_stockpile.md`
- research: `docs/research/B003_SOURCES.md`（存在する場合）
- preview: `preview/article_b003.html`
- production: `water-outage/portable-toilet-stockpile.html`
