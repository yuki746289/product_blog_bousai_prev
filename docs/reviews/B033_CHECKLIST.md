...
- reader_problem: `ペットの防災は何を準備する？同行避難・備蓄・持ち出し品を整理` に対応する判断・準備事項を整理したい
...
- source: `content/articles/B033_pet_disaster_preparedness.md`
- research: `docs/research/B033_SOURCES.md`（存在する場合）
- preview: `preview/article_b033.html`
- production: `guide/pet-disaster-preparedness.html`
