...
- reader_problem: `大雨・水害にどう備える？まず知っておきたい基本` に対応する判断・準備事項を整理したい
...
- source: `content/articles/B005_flood_preparedness_basics.md`
- research: `docs/research/B005_SOURCES.md`（存在する場合）
- preview: `preview/article_b005.html`
- production: `flood/flood-preparedness-basics.html`
