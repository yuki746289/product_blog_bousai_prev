...
- reader_problem: `車に積んでおきたい防災用品｜車載用に考える` に対応する判断・準備事項を整理したい
...
- source: `content/articles/B029_car_emergency_kit.md`
- research: `docs/research/B029_SOURCES.md`（存在する場合）
- preview: `preview/article_b029.html`
- production: `vehicle/car-emergency-kit.html`
