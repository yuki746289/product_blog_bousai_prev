...
| C02 出典・安全性 | PASS | 6件。現行補償は2026年資料、写真手順のみ2018年資料を限定利用 |
...
- PASS: 火災保険加入だけで水災補償ありと断定しない
- PASS: 建物と家財を別契約として整理
- PASS: 床上浸水だけで支払いを断定しない
- PASS: 写真記録より人身安全・感電等の回避を優先
...
- page_job: 住宅水災について建物/家財・支払条件を契約書類で確認させる
- next_action: 水災補償、対象、免責・条件を確認し、不明点を契約先へ照会

## 5. 証跡

- sources: `docs/research/B013_SOURCES.md`
- article: `content/articles/B013_fire_insurance_water_damage.md`
- preview: `preview/article_b013.html`
