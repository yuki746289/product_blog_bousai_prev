...
- reader_problem: `台風が来る前に何をする？家庭の事前チェック` に対応する判断・準備事項を整理したい
...
- source: `content/articles/B006_typhoon_preparation_checklist.md`
- research: `docs/research/B006_SOURCES.md`（存在する場合）
- preview: `preview/article_b006.html`
- production: `typhoon/typhoon-preparation-checklist.html`
