...
- reader_problem: `防災リュックは何L必要？中身・重さから容量を決める考え方` に対応する判断・準備事項を整理したい
...
- research: `docs/research/B032_SOURCES.md`（存在する場合）
- preview: `preview/article_b032.html`
- production: `guide/emergency-bag-capacity.html`
