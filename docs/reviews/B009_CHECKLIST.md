...
- reader_problem: `冠水した道路を車で走る危険｜避けるべき理由を整理` に対応する判断・準備事項を整理したい
...
- source: `content/articles/B009_driving_flooded_road_risk.md`
- research: `docs/research/B009_SOURCES.md`（存在する場合）
- preview: `preview/article_b009.html`
- production: `vehicle/driving-flooded-road-risk.html`
