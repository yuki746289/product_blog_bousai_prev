...
- reader_problem: `ポータブル電源は防災に必要？用途と注意点` に対応する判断・準備事項を整理したい
...
| E09 商品/アフィリエイト | REQUIRED | PASS。商品・Amazon導線を本文の判断材料の後に置き、現行商品・ASIN・価格表現を再確認。商品画像のアカウント/提供元固有の利用条件は U09 で追跡 |
...
| E12 セキュリティ/法務/権利/プライバシー | REQUIRED | PASS_WITH_FOLLOW_UP。著作権・広告表示・外部リンクを確認。商品画像の提供元固有条件は U09 に残し、確認済みと偽装しない |
...
| C02 出典・安全性 | PASS | 確認済み一次・公的/メーカー情報を優先。source_checked_at=2026-09-04。NITEのリコール注意喚起を追加し、異常がなくても対象品は使用中止と明示 |
...
| C06 商品導線/商品記事 | PASS | 具体商品は用途・判断基準の後に配置。Amazon現在価格を静的固定しない |
...
| S03 法務/権利/広告/プライバシー | PASS_WITH_FOLLOW_UP | 商品画像の提供方法・利用条件のアカウント固有確認はU09へ明示的に残す |
...
- source: `content/articles/B028_portable_power_station_disaster.md`
- research: `docs/research/B028_SOURCES.md`（存在する場合）
- preview: `preview/article_b028.html`
- production: `goods/portable-power-station-disaster.html`
- user-side: `docs/USER_ACTION_ITEMS.md`
- U03: 実スマートフォンでの横断UX確認はサイト共通対応事項として継続
- U09: 商品画像のAmazon/メーカー利用条件・提供方法はアカウント固有確認として継続
