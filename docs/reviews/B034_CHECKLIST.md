...
- reader_problem: `赤ちゃんの防災備蓄｜ミルク・離乳食・おむつ・衛生用品をどう備える？` に対応する判断・準備事項を整理したい
...
- source: `content/articles/B034_baby_disaster_stockpile.md`
- research: `docs/research/B034_SOURCES.md`（存在する場合）
- preview: `preview/article_b034.html`
- production: `guide/baby-disaster-stockpile.html`
