...
- reader_problem: `防災は何から始める？家庭で最初に確認したい基本項目` に対応する判断・準備事項を整理したい
...
- research: `docs/research/B001_SOURCES.md`（存在する場合）
- preview: `preview/article_sample.html`
- production: `guide/first-disaster-preparedness.html`
