...
| C02 出典・安全性 | PASS | 3件。福岡管区気象台・気象庁・内閣府の現行公開情報を2026-09-04再確認 |
...
- PASS: 前日だから必ず屋外作業可能とはせず予報から締切を決める
- PASS: 窓テープ等で破損防止を保証しない
- PASS: 医療機器を一般バッテリーで代用可能と断定しない
- PASS: 強風中の屋外回収・川海確認・冠水路走行を禁止側で明記
...
- next_action: 風雨が強まる前に屋外作業を終え、接近時は住宅作業を打ち切って安全確保へ移る

## 5. 証跡

- sources: `docs/research/B021_SOURCES.md`
- article: `content/articles/B021_typhoon_day_before_checklist.md`
- preview: `preview/article_b021.html`
