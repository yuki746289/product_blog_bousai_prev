...
- reader_problem: `非常食は何日分必要？3日〜1週間の備蓄とローリングストック` に対応する判断・準備事項を整理したい
...
- source: `content/articles/B026_emergency_food_stockpile.md`
- research: `docs/research/B026_SOURCES.md`（存在する場合）
- preview: `preview/article_b026.html`
- production: `guide/emergency-food-stockpile.html`
